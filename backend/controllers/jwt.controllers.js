...
exports.checkToken = (req, res, next) => {//1
    ...
    if (req.path === '/users/login' || req.path === '/users/new' || req.path === '/eventos/all' || req.path === '/eventos/filtrar' || req.path === '/eventos/all/active' || req.path === '/eventos/all/today' || '/eventos/new') {//2
